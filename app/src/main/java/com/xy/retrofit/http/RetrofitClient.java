...
import com.xy.retrofit.http.interceptor.OnOffLineCachedInterceptor;
import com.xy.retrofit.http.interceptor.UserAgentInterceptor;
...
public class RetrofitClient {
    ...
    public RetrofitClient(Context context) {
        ...
        retrofit = new Retrofit.Builder()
                .client(okHttpClient)
                .baseUrl(ApiConstants.GITHUB_BASEURL)
